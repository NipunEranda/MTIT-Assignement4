...
public class DBManager {
	...
	static class CustomerClass {
		...
		public static JSONObject updateCustomerDetails(String id, String firstName, String lastName, String initials,
				...
				if (rs != null) {
					while (rs.next()) {
						...
						Customer c = new Customer(Long.parseLong(rs.getString(1)), rs.getString(2), rs.getString(3),
								rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8),l);
						customerList.add(c);
					}
